...
export const PRAYERS: Prayer[] = [
    ...
    { id: 'protect_from_magic', name: 'Protect from Magic', description: 'Grants total protection from magical attacks.', level: 58, drainRate: 15, iconUrl: 'https://api.iconify.design/game-icons:fire-ray.svg', type: PrayerType.PROTECTION, protection: 'magic', group: 'protection' },
    { id: 'protect_from_ranged', name: 'Protect from Ranged', description: 'Grants total protection from ranged attacks.', level: 61, drainRate: 15, iconUrl: 'https://api.iconify.design/game-icons:bow-arrow.svg', type: PrayerType.PROTECTION, protection: 'ranged', group: 'protection' },
    { id: 'protect_from_melee', name: 'Protect from Melee', description: 'Grants total protection from melee attacks.', level: 65, drainRate: 15, iconUrl: 'https://api.iconify.design/game-icons:sword-clash.svg', type: PrayerType.PROTECTION, protection: 'melee', group: 'protection' },
];