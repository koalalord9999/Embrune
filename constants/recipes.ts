...
export const RENDERING_RECIPES: RenderingRecipe[] = [
    { fatId: 'refined_grease', level: 1, xp: 10, flaskId: 'refined_grease_flask' },
...
export const SMITHING_RECIPES = [
    ...
    { itemId: 'bronze_med_helm', level: 3, barsRequired: 1, xp: 12.5, barType: 'bronze_bar' },
    { itemId: 'bronze_square_shield', level: 5, barsRequired: 2, xp: 25, barType: 'bronze_bar' },
    { itemId: 'bronze_scimitar', level: 6, barsRequired: 2, xp: 25, barType: 'bronze_bar' },
    { itemId: 'bronze_longsword', level: 6, barsRequired: 2, xp: 25, barType: 'bronze_bar' },
    ...
    { itemId: 'bronze_chainbody', level: 9, barsRequired: 3, xp: 37.5, barType: 'bronze_bar' },
    ...
    { itemId: 'bronze_greatsword', level: 14, barsRequired: 5, xp: 62.5, barType: 'bronze_bar' },
    // Iron
    ...
    { itemId: 'iron_longsword', level: 21, barsRequired: 2, xp: 50, barType: 'iron_bar' },
    ...
    { itemId: 'iron_greatsword', level: 29, barsRequired: 5, xp: 125, barType: 'iron_bar' },
    { itemId: 'iron_med_helm', level: 20, barsRequired: 1, xp: 25, barType: 'iron_bar' },
    { itemId: 'iron_square_shield', level: 22, barsRequired: 2, xp: 50, barType: 'iron_bar' },
    { itemId: 'iron_chainbody', level: 25, barsRequired: 3, xp: 75, barType: 'iron_bar' },
    // Steel
    ...
    { itemId: 'steel_longsword', level: 36, barsRequired: 2, xp: 75, barType: 'steel_bar' },
    ...
    { itemId: 'steel_greatsword', level: 44, barsRequired: 5, xp: 187.5, barType: 'steel_bar' },
    { itemId: 'steel_med_helm', level: 35, barsRequired: 1, xp: 37.5, barType: 'steel_bar' },
    { itemId: 'steel_square_shield', level: 37, barsRequired: 2, xp: 75, barType: 'steel_bar' },
    { itemId: 'steel_chainbody', level: 40, barsRequired: 3, xp: 112.5, barType: 'steel_bar' },
    // Mithril
    ...
    { itemId: 'mithril_longsword', level: 56, barsRequired: 2, xp: 100, barType: 'mithril_bar' },
    ...
    { itemId: 'mithril_greatsword', level: 64, barsRequired: 5, xp: 250, barType: 'mithril_bar' },
    { itemId: 'mithril_med_helm', level: 53, barsRequired: 1, xp: 50, barType: 'mithril_bar' },
    { itemId: 'mithril_square_shield', level: 55, barsRequired: 2, xp: 100, barType: 'mithril_bar' },
    { itemId: 'mithril_chainbody', level: 58, barsRequired: 3, xp: 150, barType: 'mithril_bar' },
    // Adamantite
    ...
    { itemId: 'adamantite_longsword', level: 71, barsRequired: 2, xp: 125, barType: 'adamantite_bar' },
    ...
    { itemId: 'adamantite_greatsword', level: 79, barsRequired: 5, xp: 312.5, barType: 'adamantite_bar' },
    { itemId: 'adamantite_med_helm', level: 68, barsRequired: 1, xp: 62.5, barType: 'adamantite_bar' },
    { itemId: 'adamantite_square_shield', level: 70, barsRequired: 2, xp: 125, barType: 'adamantite_bar' },
    { itemId: 'adamantite_chainbody', level: 73, barsRequired: 3, xp: 187.5, barType: 'adamantite_bar' },
    // Runic
    ...
    { itemId: 'runic_longsword', level: 86, barsRequired: 2, xp: 150, barType: 'runic_bar' },
    ...
    { itemId: 'runic_greatsword', level: 94, barsRequired: 5, xp: 375, barType: 'runic_bar' },
    { itemId: 'runic_med_helm', level: 83, barsRequired: 1, xp: 75, barType: 'runic_bar' },
    { itemId: 'runic_square_shield', level: 85, barsRequired: 2, xp: 150, barType: 'runic_bar' },
    { itemId: 'runic_chainbody', level: 88, barsRequired: 3, xp: 225, barType: 'runic_bar' },
];
