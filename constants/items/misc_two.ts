...
export const misc_two: Item[] = [
    ...
    { id: 'infernal_key_fragment', itemNum: 116, name: 'Infernal Key Fragment', description: 'A piece of a key that radiates a malevolent heat.', stackable: false, value: 0, iconUrl: 'key', material: 'rune-ember' },
