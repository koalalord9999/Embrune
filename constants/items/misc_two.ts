...
export const misc_two: Item[] = [
    ...
    { id: 'shard_of_true_ice', name: 'Shard of True Ice', description: 'A piece of ice that never melts. It is cold enough to shatter magical structures.', stackable: false, value: 0, iconUrl: 'https://api.iconify.design/game-icons:ice-cube.svg', material: 'rune-aqua' },
    { id: 'bar_of_transmuted_gold', name: 'Bar of Transmuted Gold', description: 'A bar of pure, magical gold, transmuted from runic metal. A testament to mastery over Transmutation.', stackable: false, value: 0, iconUrl: 'https://api.iconify.design/game-icons:gold-bar.svg', material: 'gold' },
];