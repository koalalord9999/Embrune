...
export const undead: Monster[] = [
    {
        ...
        mainDrops: [
            ...
            { itemId: 'mithril_ore', chance: "1/10", minQuantity: 5, maxQuantity: 10, noted: true },
            { itemId: 'fishing_bait', chance: "1/4", minQuantity: 15, maxQuantity: 40 },
        ],
    ...
    },
    {
        ...
        mainDrops: [
            ...
            { itemId: 'steel_chainbody', chance: "1/64" },
            { itemId: 'stone_rune', chance: "1/10", minQuantity: 5, maxQuantity: 15 },
        ],
    ...
    },
    {
        ...
        mainDrops: [
            ...
            { itemId: 'mithril_med_helm', chance: "1/64" },
            { itemId: 'fishing_bait', chance: "1/10", minQuantity: 10, maxQuantity: 20 },
        ],
        tertiaryDrops: [{ itemId: 'nexus_talisman', chance: 1 / 128, minQuantity: 1, maxQuantity: 1 }],
    ...
    },
    {
        ...
        mainDrops: [
            ...
            { itemId: 'iron_ore', chance: "1/8", minQuantity: 5, maxQuantity: 15, noted: true },
            { itemId: 'stone_rune', chance: "1/5", minQuantity: 15, maxQuantity: 25 },
        ],
    ...
    },
    {
        ...
        mainDrops: [
            ...
            { itemId: 'bronze_sword', chance: "1/64" }
        ],
    ...
    },
    {
        ...
        mainDrops: [
            ...
            { itemId: 'willow_logs', chance: "1/5", minQuantity: 5, maxQuantity: 15, noted: true },
            { itemId: 'fishing_bait', chance: "1/5", minQuantity: 15, maxQuantity: 25 }
        ],
        tertiaryDrops: [{ itemId: 'nexus_talisman', chance: 1 / 128, minQuantity: 1, maxQuantity: 1 }],
    ...
    },
    {
        ...
        mainDrops: [
            ...
            { itemId: 'iron_sword', chance: "1/64" },
            { itemId: 'raw_tuna', chance: "1/10", minQuantity: 1, maxQuantity: 2, noted: true }
        ],
        tertiaryDrops: [{ itemId: 'nexus_talisman', chance: 1 / 128, minQuantity: 1, maxQuantity: 1 }],
