...
export interface Item {
  ...
  consumable?: {
    ...
    restoresStats?: { percent: number; base: number; };
...
export interface Monster {
  ...
  slayerLevel?: number;
  requiredSlayerItem?: ItemId;
  source?: 'slayer' | 'respite';
}
