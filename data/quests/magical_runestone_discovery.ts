...
export const magicalRunestoneDiscovery: Quest = {
    ...
    npcDefs: {
        wizard_elmsworth: { npcName: 'Wizard Elmsworth', npcIcon: 'wizard-face' },
        wizard_elmsworth_projection: { npcName: 'Wizard Elmsworth (Projection)', npcIcon: 'wizard-face' },
        approach_the_altar: { npcName: 'Approach the altar', npcIcon: 'rune-stone' },
    },
    ...
    dialogue: {
        ...
        mrd_projection_intro: {
            npc: 'wizard_elmsworth_projection',
