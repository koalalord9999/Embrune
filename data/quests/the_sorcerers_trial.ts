/**
 * Quest: The Sorcerer's Trial (Main Quest - Magic Path)
 * =======================================================
 *
 * Grand Narrative & Player Experience:
 * ------------------------------------
 * After completing "The Saint's First Step," the player has proven their connection to the divine aspects.
 * Librarian Anya, a master scholar of the arcane, approaches them. While Brother Thaddeus's path involved
 * faith and offering, Anya believes true communion with the God of Sorcery requires a practical thesis—a
 * demonstration of absolute mastery over magic's fundamental principles. It is, in essence, a final exam
 * for an Archmage.
 *
 * Anya has unearthed an ancient, dangerous rite: a trial to not just face, but to *construct and then deconstruct*
 * the Avatar of Sorcery itself. The trial is structured around the three pillars of magic: Creation,
 * Destruction, and Transmutation. This isn't a monster hunt; it's a journey of profound magical understanding
 * that will take the player across the entire known world.
 *
 * --- The Trial of Creation: Forging a New Rune ---
 * "To create is not to replicate, but to innovate," Anya explains. She tasks the player not with crafting
 * existing runes, but with creating a brand new one from a fragmented formula. She provides a "Cracked Runic Tablet"
 * detailing part of a formula for a 'Rune of Attunement'. To complete it, the player must seek two missing
 * fragments of knowledge.
 *
 * Part 1 (Travel & Lore): The first fragment is with a reclusive hermit mage, a former colleague of Anya's,
 * who lives in a hidden part of the Wyrmwood Grove. The hermit is eccentric and speaks in riddles, forcing the
 * player to decipher his clues to receive the "Fragment of Intent."
 *
 * Part 2 (Travel & Puzzle): The second fragment, the "Fragment of Shape," is not written but carved. Anya's research
 * points to an ancient monolith in the Sunbright Plains. The player must wait for a specific time of day (e.g., dawn)
 * for the light to reveal the inscription, which they must then copy.
 *
 * Part 3 (Creation & Interaction): With all fragments, the player returns to Anya. She helps them combine the knowledge,
 * but the final rune is inert. "It lacks a spark," she says. "It must be imprinted with raw, untamed power." The player
 * must take the 'Inert Rune of Attunement' to a place of raw elemental fury—the heart of a storm on the Gale-Swept Peaks
 * or a geyser in the Volcanic Steam Vents. By using the inert rune on the environment during the event (e.g., a lightning
 * strike or eruption), it becomes the 'Imprinted Rune of Attunement'. This act of will, of capturing raw power, is the true
 * test of Creation.
 *
 * --- The Trial of Destruction: Taming Chaos ---
 * "Any fool can break things," Anya scoffs. "A master controls the breaking." For this, she sends the player to her
 * foil: Zafira, the pragmatic, slightly unhinged alchemist in Fouthia. Zafira finds the entire "academic" trial hilarious.
 * "Anya wants you to learn about Destruction from her dusty books? Hah! Let's get our hands dirty."
 *
 * Zafira agrees to help, but requires rare ingredients: the claw of a mighty Wyvern and the volatile essence of Brimstone.
 * Upon the player's return, Zafira doesn't just imbue the claw. She creates a violently unstable energy core, a miniature
 * magical black hole contained in a dwarven vessel. "Here," she says with a manic grin. "It wants to explode. Your job
 * is to teach it *patience*."
 *
 * The player must take the 'Unstable Core' and temper it by exposing it to three great forces of the world, teaching it
 * what *not* to destroy:
 * 1. The Heat of Creation: Take it to the great forge in the Dwarven Outpost. The player must 'Use' it on the anvil while a
 *    dwarf is working, allowing it to absorb the intense heat without detonating.
 * 2. The Pressure of the Deep: Take it to the deepest part of the Sunken Labyrinth. The immense water pressure threatens
 *    to crush the vessel, and the player must survive down there for a time, letting the core stabilize.
 * 3. The Silence of the Void: Take it to the quietest, most magically null place possible—perhaps the heart of the Salt Flats,
 *    where the core learns stillness.
 *
 * After these trials, the player returns to Zafira. She nods, impressed. "You've tamed chaos. You understand." She performs
 * a final ritual, shaping the energy into a 'Core of Controlled Destruction'.
 *
 * --- The Trial of Transmutation: Rewriting Reality ---
 * "The final test," Anya says, her voice filled with reverence. "To change one thing into another is to rewrite a line in the
 * universe's own song." The task: transform a Runic Bar—a metal so magically dense its very nature is almost immutable—into
 * pure, magical gold.
 *
 * Anya explains that simple transmutation spells, which turn items to coin, are insufficient. Such a profound change requires an
 * alchemical paradox: extreme heat and extreme cold applied simultaneously. The player must use the 'Superheat Ore' spell, but
 * its fire must be focused through two opposing catalysts.
 *
 * Catalyst of Cold: The first is a 'Shard of True Ice', a piece of ice that never melts, found only in the deepest, most frigid
 * chamber of the Frostfang Peaks, likely guarded by a powerful ice creature. This shard is needed to shatter the runic bar's
 * inherent magical structure.
 *
 * Catalyst of Purity: The second is a cut 'Sunstone', a gem of perfect clarity and inner light, representing the sun's pure,
 * creative fire. This will guide the molten, unstructured essence of the runic bar to reform as gold. An uncut sunstone won't
 * do; it must be perfectly cut, requiring a high Crafting level.
 *
 * The ritual itself must be performed at a place of immense magical confluence: the Astral Altar at the apex of the Magus Spire.
 * There, the player must place the Runic Bar, Shard of True Ice, and Sunstone on the altar and cast the 'Superheat Ore' spell.
 * The result is a 'Bar of Transmuted Gold', a testament to their mastery over elemental forces.
 *
 * --- The Summoning & The Final Exam ---
 * With the 'Imprinted Rune of Attunement' (Creation), the 'Core of Controlled Destruction' (Destruction), and the 'Bar of
 * Transmuted Gold' (Transmutation), the player returns to Anya. She reveals the final step: take these three foci to the
 * Elemental Shrine in the Wyrmwood Grove.
 *
 * The shrine has three pedestals. As the player places each item, they don't just act as keys; they *become* the Avatar.
 * - The Rune of Attunement shatters into light, forming the Avatar's consciousness.
 * - The Core of Controlled Destruction floats to its chest, becoming its pulsating heart.
 * - The Bar of Transmuted Gold melts into liquid light, flowing and shaping itself into the Avatar's ephemeral body.
 *
 * The player has not just summoned a monster; they have *created* their final exam. The Avatar attacks with abilities reflecting
 * its components: creating short-lived duplicates (Creation), firing focused beams of destructive energy (Destruction), and a
 * special attack that temporarily transmutes the player's equipped weapon into a 'Useless Fish' (Transmutation).
 *
 * --- The Reward: A Vision of Understanding ---
 * Upon defeating the Avatar, it deconstructs back into raw energy, which flows into the player. They are not just given a reward;
 * they experience a vision. They see the "threads" of magic that make up a spell, feel their texture, and instinctively understand
 * how to weave a "counter-spell" around themselves. This epiphany manifests as the innate ability to use the "Protect from Magic" prayer.
 *
 * Returning to Anya, she is not just pleased; she is awestruck. "You have done more than pass a test," she says. "You have communed
 * with the very grammar of the universe. You are no longer just an adventurer who uses magic. You are a true Archmage." She rewards them
 * generously, acknowledging them as a peer. The trial is complete.
 */
...
export const theSorcerersTrial: Quest = {
    ...
    stages: [
        ...
        { description: "Find the ancient monolith in the Sunbright Plains and decipher the 'Fragment of Shape'.", requirement: { type: 'gather', items: [{ itemId: 'fragment_of_shape', quantity: 1 }] } }, // 2
        { description: "Return to Anya with the fragments.", requirement: { type: 'talk', poiId: 'sanctity_library', npcName: 'Librarian Anya' } }, // 3
        { description: "Charge the Inert Rune at a place of elemental power.", requirement: { type: 'gather', items: [{ itemId: 'imprinted_rune_of_attunement', quantity: 1 }] } }, // 4
        { description: "Return to Anya.", requirement: { type: 'talk', poiId: 'sanctity_library', npcName: 'Librarian Anya' } }, // 5
        { description: "Speak to Zafira in Fouthia.", requirement: { type: 'talk', poiId: 'fouthia_alchemist', npcName: 'Zafira the Alchemist' } }, // 6
        { description: "Gather 1 Wyvern Claw.", requirement: { type: 'gather', items: [{ itemId: 'wyvern_claw', quantity: 1 }] } }, // 7
        { description: "Return to Zafira with the Wyvern Claw.", requirement: { type: 'talk', poiId: 'fouthia_alchemist', npcName: 'Zafira the Alchemist' } }, // 8
        { description: "Gather 10 Brimstone.", requirement: { type: 'gather', items: [{ itemId: 'brimstone', quantity: 10 }] } }, // 9
        { description: "Return to Zafira with the Brimstone.", requirement: { type: 'talk', poiId: 'fouthia_alchemist', npcName: 'Zafira the Alchemist' } }, // 10
        { description: "Temper the Unstable Core.", requirement: { type: 'gather', items: [{ itemId: 'tempered_core', quantity: 1 }] } }, // 11
        { description: "Return to Zafira.", requirement: { type: 'talk', poiId: 'fouthia_alchemist', npcName: 'Zafira the Alchemist' } }, // 12
        { description: "Return to Anya.", requirement: { type: 'talk', poiId: 'sanctity_library', npcName: 'Librarian Anya' } }, // 13
    ...
    npcDefs: {
        librarian_anya: { npcName: 'Librarian Anya', npcIcon: 'person' },
        hermit_mage: { npcName: 'Hermit Mage', npcIcon: 'wizard-face' },
        zafira_the_alchemist: { npcName: 'Zafira the Alchemist', npcIcon: 'person' },
        ancient_monolith: { npcName: 'Ancient Monolith', npcIcon: 'standing-stones' },
        astral_altar: { npcName: 'Astral Altar', npcIcon: 'star-altar' },
        elemental_shrine: { npcName: 'Elemental Shrine', npcIcon: 'shrine' },
        avatar_of_sorcery: { npcName: 'Avatar of Sorcery', npcIcon: 'wizard-face' },
        vision_of_understanding: { npcName: 'Vision of Understanding', npcIcon: 'eye-shield' },
        durin: { npcName: 'Durin', npcIcon: 'person' },
        empty_fire_pit: { npcName: 'Empty Fire Pit', npcIcon: 'fire-pit' },
        lit_fire_pit: { npcName: 'Lit Fire Pit', npcIcon: 'fire-lit' },
        mystical_fire_pit: { npcName: 'Mystical Fire Pit', npcIcon: 'fire-mystical' },
    },
    ...
    dialogue: {
        ...
        tst_intro_defend_thaddeus: {
            npc: 'librarian_anya',
            text: "Not wrong, merely... incomplete. Faith is a foundation, but a true communion with the Aspect of Sorcery requires more than belief. It requires a practical thesis. A demonstration of absolute mastery.",
            responses: [
                { text: "So, a final exam?", next: 'tst_intro_explain_trial_2' },
                { text: "What kind of demonstration?", next: 'tst_intro_explain_trial' }
            ]
        },
        tst_intro_explain_trial: {
            npc: 'librarian_anya',
        ...
        tst_intro_explain_trial_2: {
            npc: 'librarian_anya',
            text: "Precisely. The final exam for an Archmage. It involves not just facing the divine, but constructing its very avatar and then deconstructing it. It is the ultimate test of understanding.",
            responses: [
                { text: "Constructing an avatar? That sounds... ambitious.", next: 'tst_intro_ready_check' },
                { text: "Tell me about the first pillar: Creation.", next: 'tst_intro_creation_task' }
            ]
        },
        tst_intro_ready_check: {
            npc: 'librarian_anya',
            text: "Your rapid growth in the arcane arts is undeniable. Whether you are 'ready' is what this trial will determine. It is a journey that will span the entire world. Are you prepared to begin?",
            responses: [
                { text: "I am. What is the first trial?", next: 'tst_intro_creation_task' },
                { text: "I need more time to prepare.", next: 'tst_intro_decline' }
            ]
        },
        tst_intro_witty_response: {
            npc: 'librarian_anya',
            text: "*Anya gives a rare, thin smile.* A party of one, with the universe as your guest. Do not take it lightly. The forces you will manipulate are the very foundations of reality.",
            responses: [
                { text: "I understand. What is the first trial?", next: 'tst_intro_creation_task' }
            ]
        },
        tst_intro_creation_task: {
            npc: 'librarian_anya',
            text: "The Trial of Creation is not to replicate, but to innovate. You will not be crafting some common rune. You will bring a new one into existence. I have this... *She presents a cracked stone tablet.* It contains a fragmented formula for a 'Rune of Attunement'.",
            responses: [
                { text: "How do I complete it?", next: 'tst_intro_creation_task_2' }
            ]
        },
        tst_intro_creation_task_2: {
            npc: 'librarian_anya',
        ...
        tst_intro_decline: {
            npc: 'librarian_anya',
            text: "Very well. True mastery cannot be rushed. The library will be here when you are ready to undertake the trial.",
            responses: []
        },
        ...
        // --- Anya Return Dialogue ---
        tst_anya_return_fragments_check: {
            npc: 'librarian_anya',
            text: "You've returned. Let's see if you have what is needed.",
            responses: [],
            conditionalResponses: [
                { text: "", check: { requirements: [{ type: 'items', items: [{ itemId: 'fragment_of_intent', quantity: 1 }, { itemId: 'fragment_of_shape', quantity: 1 }] }], successNode: 'tst_anya_combine_fragments' } },
                { text: "", check: { requirements: [], successNode: 'tst_anya_no_fragments' } }
            ]
        },
        tst_anya_no_fragments: {
            npc: 'librarian_anya',
            text: "You are still missing one of the fragments. Remember, one is held by the hermit in Wyrmwood, the other is found upon the monolith in the Sunbright Plains.",
            responses: []
        },
        tst_anya_combine_fragments: {
            npc: 'librarian_anya',
        ...
        tst_anya_return_imprinted_check: {
            npc: 'librarian_anya',
            text: "Have you charged the rune?",
            responses: [],
            conditionalResponses: [
                { text: "", check: { requirements: [{ type: 'items', items: [{ itemId: 'imprinted_rune_of_attunement', quantity: 1 }] }], successNode: 'tst_anya_return_imprinted_success' } },
                { text: "", check: { requirements: [], successNode: 'tst_anya_still_inert' } }
            ]
        },
        tst_anya_still_inert: {
            npc: 'librarian_anya',
            text: "The rune is still inert. You must seek out a place of raw elemental power. A powerful storm, a volcanic eruption... something primal.",
            responses: []
        },
        ...
        tst_anya_describe_lightning: {
            npc: 'librarian_anya',
            text: "You were struck by lightning?! Are you alright?",
            responses: [
                { text: "I'm fine. A bit tingly. But the rune seems to like it.", next: 'tst_anya_reaction_generic' }
            ]
        },
        tst_anya_describe_wave: {
            npc: 'librarian_anya',
            text: "By the tides! You could have been washed out to sea!",
            responses: [
                { text: "I took an unscheduled, very large bath. The rune is now very clean. And very powerful.", next: 'tst_anya_reaction_generic' }
            ]
        },
        tst_anya_describe_geyser: {
            npc: 'librarian_anya',
            text: "You stood in a superheated geyser? That's incredibly reckless!",
            responses: [
                { text: "I was nearly boiled alive, but hey, free sauna! And the rune absorbed the geothermal energy.", next: 'tst_anya_reaction_generic' }
            ]
        },
        tst_anya_reaction_generic: {
            npc: 'librarian_anya',
            text: "*Anya looks momentarily concerned, then her academic curiosity takes over.* Incredible! You faced the raw chaos of nature and channeled it into a focused point of creation. You have passed the first trial. You have proven you understand that to create is not just to build, but to *will* something new into existence.",
            responses: [
                { text: "What is the next trial?", next: 'tst_anya_intro_destruction' }
            ]
        },
        tst_anya_intro_destruction: {
            npc: 'librarian_anya',
            text: "But Creation is only one pillar. Any fool can make something. It takes a master to control its unmaking. Your next trial is that of Destruction. It is a concept I understand in theory, but for its practical application... you will need a different kind of teacher.",
            responses: [
                { text: "(Continue)", next: 'tst_anya_intro_destruction_2' }
            ]
        },
        tst_anya_intro_destruction_2: {
            npc: 'librarian_anya',
            text: "Go to the desert city of Fouthia. Find an alchemist named Zafira. She is... unorthodox, but her understanding of volatile energies is second to none. Tell her I sent you for a lesson in 'controlled demolition'.",
            responses: [
                { text: "I will find her.", next: 'tst_anya_destruction_farewell', actions: [{ type: 'advance_quest', questId: 'the_sorcerers_trial' }] }
            ]
        },
        tst_anya_destruction_farewell: {
            npc: 'librarian_anya',
        ...
        tst_zafira_intro_danger: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "Of course it's dangerous! That's the point! A beautiful sunset is just controlled combustion on a cosmic scale. A volcano is just the planet clearing its throat. Danger is the spice of existence! Now, are you here to cook, or are you going to complain about the heat?",
            responses: [
                { text: "I'm here to cook. You'll help?", next: 'tst_zafira_agree' }
            ]
        },
        tst_zafira_intro_jest: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "*She grins, a wild look in her eyes.* Unorthodox? Is that what she calls it? I call it 'results-oriented science'. While Anya is busy alphabetizing her scrolls, I'm busy finding out what happens when you introduce a lightning bug to a jar of swamp gas. The answer, by the way, is 'pop'. So, you want my help?",
            responses: [
                { text: "Yes, I do.", next: 'tst_zafira_agree' }
            ]
        },
        tst_zafira_agree: {
            npcName: 'Zafira the Alchemist',
        ...
        tst_zafira_agree_why_claw: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "Simple alchemy, really! A Wyvern's claw is naturally attuned to violent, fiery energy. It's tough, but more importantly, it has a bit of a temper of its own. It's not just a container; it's a co-conspirator!",
            responses: [
                { text: "A co-conspirator. Right. So, where do I find one?", next: 'tst_zafira_task_claw_short' }
            ]
        },
        tst_zafira_agree_blow_up: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "*She pauses and taps her chin.* Probably not. Maybe a 60/40 chance... in your favor, of course! Mostly. Now, about that vessel...",
            responses: [
                { text: "That's... reassuring. What do you need?", next: 'tst_zafira_task_claw' }
            ]
        },
        ...
        tst_zafira_no_claw: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "No claw? What am I supposed to do with this, my good looks? Go wrestle a Wyvern and come back when you have something for me!",
            responses: []
        },
        ...
        tst_zafira_task_brimstone: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "Brimstone! From the volcanic vents! Bring me ten pieces. The smellier, the better! Go on, chop chop! The boom-booms won't make themselves!",
            responses: [
                { text: "I'll be back with the brimstone.", next: 'tst_zafira_brimstone_farewell', actions: [{ type: 'advance_quest', questId: 'the_sorcerers_trial' }] }
            ]
        },
        tst_zafira_brimstone_farewell: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "Hurry! The potential for a glorious explosion awaits!",
            responses: []
        },
        tst_zafira_return_brimstone_check: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "Do I smell the sweet, acrid stench of progress? Did you bring me the smelly rocks?",
            responses: [
                { text: "(Give her the Brimstone)", check: { requirements: [{ type: 'items', items: [{ itemId: 'brimstone', quantity: 10 }] }], successNode: 'tst_zafira_return_brimstone_success', failureNode: 'tst_zafira_no_brimstone' } }
            ]
        },
        tst_zafira_no_brimstone: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "No brimstone? This claw isn't going to fill itself with explosive potential, you know! Get back to the vents!",
            responses: []
        },
        ...
        tst_zafira_core_farewell_direct: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "Good! Now get going before it gets any ideas!",
            responses: []
        },
        tst_zafira_core_farewell: {
            npcName: 'Zafira the Alchemist',
            npcIcon: 'person',
            text: "Or do! Just make sure I'm not nearby. Or that I am! I can't decide! Just go!",
            responses: []
        },
        ...
        tst_pit_1_empty: {
            ...
            responses: [],
            conditionalResponses: [
                { text: "Light with Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 1 }, { type: 'items', items: [{ itemId: 'logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_1', logType: 'logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 45 }] },
                { text: "Light with Driftwood Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 5 }, { type: 'items', items: [{ itemId: 'driftwood_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'driftwood_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_1', logType: 'driftwood_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 45 }] },
                { text: "Light with Oak Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 15 }, { type: 'items', items: [{ itemId: 'oak_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'oak_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_1', logType: 'oak_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 60 }] },
                { text: "Light with Willow Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 30 }, { type: 'items', items: [{ itemId: 'willow_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'willow_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_1', logType: 'willow_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 90 }] },
                { text: "Light with Maple Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 45 }, { type: 'items', items: [{ itemId: 'maple_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'maple_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_1', logType: 'maple_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 135 }] },
                { text: "Light with Mahogany Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 50 }, { type: 'items', items: [{ itemId: 'mahogany_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'mahogany_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_1', logType: 'mahogany_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 157.5 }] },
                { text: "Light with Yew Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 60 }, { type: 'items', items: [{ itemId: 'yew_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'yew_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_1', logType: 'yew_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 202.5 }] },
                { text: "Light with Feywood Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 45 }, { type: 'items', items: [{ itemId: 'feywood_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'feywood_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_1', logType: 'feywood_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 135 }] },
                { text: "Leave it be." }
            ]
        },
        tst_pit_1_lit: {
        ...
        tst_pit_2_empty: {
            ...
            responses: [],
            conditionalResponses: [
                { text: "Light with Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 1 }, { type: 'items', items: [{ itemId: 'logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_2', logType: 'logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 45 }] },
                { text: "Light with Driftwood Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 5 }, { type: 'items', items: [{ itemId: 'driftwood_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'driftwood_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_2', logType: 'driftwood_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 45 }] },
                { text: "Light with Oak Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 15 }, { type: 'items', items: [{ itemId: 'oak_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'oak_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_2', logType: 'oak_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 60 }] },
                { text: "Light with Willow Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 30 }, { type: 'items', items: [{ itemId: 'willow_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'willow_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_2', logType: 'willow_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 90 }] },
                { text: "Light with Maple Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 45 }, { type: 'items', items: [{ itemId: 'maple_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'maple_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_2', logType: 'maple_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 135 }] },
                { text: "Light with Mahogany Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 50 }, { type: 'items', items: [{ itemId: 'mahogany_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'mahogany_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_2', logType: 'mahogany_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 157.5 }] },
                { text: "Light with Yew Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 60 }, { type: 'items', items: [{ itemId: 'yew_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'yew_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_2', logType: 'yew_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 202.5 }] },
                { text: "Light with Feywood Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 45 }, { type: 'items', items: [{ itemId: 'feywood_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'feywood_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_2', logType: 'feywood_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 135 }] },
                { text: "Leave it be." }
            ]
        },
        tst_pit_2_lit: {
        ...
        tst_pit_3_empty: {
            ...
            responses: [],
            conditionalResponses: [
                { text: "Light with Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 1 }, { type: 'items', items: [{ itemId: 'logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_3', logType: 'logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 45 }] },
                { text: "Light with Driftwood Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 5 }, { type: 'items', items: [{ itemId: 'driftwood_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'driftwood_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_3', logType: 'driftwood_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 45 }] },
                { text: "Light with Oak Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 15 }, { type: 'items', items: [{ itemId: 'oak_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'oak_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_3', logType: 'oak_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 60 }] },
                { text: "Light with Willow Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 30 }, { type: 'items', items: [{ itemId: 'willow_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'willow_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_3', logType: 'willow_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 90 }] },
                { text: "Light with Maple Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 45 }, { type: 'items', items: [{ itemId: 'maple_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'maple_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_3', logType: 'maple_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 135 }] },
                { text: "Light with Mahogany Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 50 }, { type: 'items', items: [{ itemId: 'mahogany_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'mahogany_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_3', logType: 'mahogany_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 157.5 }] },
                { text: "Light with Yew Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 60 }, { type: 'items', items: [{ itemId: 'yew_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'yew_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_3', logType: 'yew_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 202.5 }] },
                { text: "Light with Feywood Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 45 }, { type: 'items', items: [{ itemId: 'feywood_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'feywood_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_3', logType: 'feywood_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 135 }] },
                { text: "Leave it be." }
            ]
        },
        tst_pit_3_lit: {
        ...
        tst_pit_4_empty: {
            ...
            responses: [],
            conditionalResponses: [
                { text: "Light with Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 1 }, { type: 'items', items: [{ itemId: 'logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_4', logType: 'logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 45 }] },
                { text: "Light with Driftwood Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 5 }, { type: 'items', items: [{ itemId: 'driftwood_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'driftwood_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_4', logType: 'driftwood_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 45 }] },
                { text: "Light with Oak Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 15 }, { type: 'items', items: [{ itemId: 'oak_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'oak_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_4', logType: 'oak_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 60 }] },
                { text: "Light with Willow Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 30 }, { type: 'items', items: [{ itemId: 'willow_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'willow_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_4', logType: 'willow_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 90 }] },
                { text: "Light with Maple Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 45 }, { type: 'items', items: [{ itemId: 'maple_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'maple_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_4', logType: 'maple_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 135 }] },
                { text: "Light with Mahogany Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 50 }, { type: 'items', items: [{ itemId: 'mahogany_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'mahogany_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_4', logType: 'mahogany_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 157.5 }] },
                { text: "Light with Yew Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 60 }, { type: 'items', items: [{ itemId: 'yew_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'yew_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_4', logType: 'yew_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 202.5 }] },
                { text: "Light with Feywood Logs", check: { requirements: [{ type: 'skill', skill: SkillName.Firemaking, level: 45 }, { type: 'items', items: [{ itemId: 'feywood_logs', quantity: 1 }, { itemId: 'tinderbox', quantity: 1 }] }] }, actions: [{ type: 'take_item', itemId: 'feywood_logs', quantity: 1 }, { type: 'light_monolith_fire', pitId: 'monolith_pit_4', logType: 'feywood_logs' }, { type: 'give_xp', skill: SkillName.Firemaking, amount: 135 }] },
                { text: "Leave it be." }
            ]
        },
        tst_pit_4_lit: {
