...
export const minePois: Record<string, POI> = {
    stonebreak_mine: {
        ...
        activities: [
            {
                type: "skilling",
                id: "stonebreak_copper_1",
                name: "Mine Copper Rock",
            ...
            {
                type: "skilling",
                id: "stonebreak_large_copper_1",
                name: "Mine Large Copper Rock",
                skill: SkillName.Mining,
                requiredLevel: 15,
                loot: [
                    {
            ...
            {
                type: "skilling",
                id: "stonebreak_large_tin_1",
                name: "Mine Large Tin Rock",
                skill: SkillName.Mining,
                requiredLevel: 15,
                loot: [
                    {
        ...
        activities: [
            {
                type: "thieving_lockpick",
                id: "cc_chest_1",
                targetName: "Crystalline Chest",
                lootTableId: "thieving_dungeon_chest_mid",
            },
            {
                type: "skilling",
                id: "crystal_cavern_silver_1",
