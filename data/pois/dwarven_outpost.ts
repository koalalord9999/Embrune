        ...
        activities: [
            ...
            { type: 'shop', shopId: 'dwarven_pickaxes' },
            {
                ...
                conditionalGreetings: [
                    ...
                    { text: "By Moradin's beard... what in the blazes are you carrying? Don't just stand there with that thing, come speak to me before it melts my workshop floor!", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', stage: 11 }, { type: 'items', items: [{ itemId: 'unstable_core', quantity: 1 }] }] } },
                    { text: "My boys are hammering away at that core of yours. Have a seat, take a load off. Proper tempering takes time.", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', stage: 11 }, { type: 'world_state', property: 'destructionTrialProgress' as any, value: 'started', operator: 'eq' as any }] } },
