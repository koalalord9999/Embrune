...
export const theFeywoodPois: Record<string, POI> = {
    feywood_entrance: {
        ...
        activities: [
            {
                type: "skilling",
                name: "Ancient Feywood Tree",
                id: "feywood_entrance_tree",
    ...
    heart_of_the_fey: {
        ...
        activities: [
            {
                type: "skilling",
                name: "Colossal Feywood Tree",
                id: "heart_feywood_tree",
                skill: SkillName.Woodcutting,
                requiredLevel: 70,
                loot: [
                    {
