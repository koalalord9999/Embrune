...
export const isleOfWhispersPois: Record<string, POI> = {
        ...
        activities: [
            {
                ...
                dialogue: {
                    start: {
                        ...
                        responses: [
                            {
                                text: "Take the ferry to Silverhaven. (10 coins)",
                                check: {
                                    requirements: [
                                        {
                                            type: "coins",
                                    ...
                                    successNode: "travel_silverhaven_success",
    ...
    salty_supplies: {
        ...
        activities: [
            {
                type: "shop",
                shopId: "isle_of_whispers_general",
            },
            {
                type: "thieving_lockpick",
                id: "iow_supplies_chest_1",
                targetName: "Supply Crate",
                lootTableId: "thieving_house_cabinet_locked",
            },
        ],
        regionId: "isle_of_whispers",
        x: 475,
    ...
    crabclaw_isle: {
        ...
        activities: [
            ...
            {
                type: "skilling",
                id: "crabclaw_ocean_trap_lobster",
                name: "Set Ocean Trap",
                skill: SkillName.Fishing,
                requiredLevel: 50,
                loot: [
    ...
    shipwreck_graveyard: {
        ...
        activities: [
            ...
            {
                type: "thieving_lockpick",
                id: "iow_shipwreck_chest_1",
                targetName: "Waterlogged Chest",
                lootTableId: "thieving_dungeon_chest_mid",
            },
            {
                type: "ground_item",
                id: "shipwreck_graveyard_logs",
                itemId: "driftwood_logs",
                resourceCount: 1,
                respawnTimer: 120000,
            },
            {
                ...
                name: "Start Shipwreck Leap (Lvl 55)",
                courseId: "shipwreck_graveyard_leap",
            },
        ],
        regionId: "isle_of_whispers",
        x: 550,
    ...
    tidal_flats: {
        ...
        activities: [
            ...
            {
                type: "skilling",
                id: "tidal_flats_ocean_trap_lobster",
                name: "Set Ocean Trap",
                skill: SkillName.Fishing,
                requiredLevel: 50,
                loot: [
    ...
    sirens_cove: {
        ...
        activities: [
            ...
            {
                type: "skilling",
                id: "sirens_cove_ocean_trap_lobster",
                name: "Set Ocean Trap",
                skill: SkillName.Fishing,
                requiredLevel: 50,
                loot: [
    ...
    volcanic_vents: {
        ...
        activities: [
            ...
            {
                type: "skilling",
                id: "volcanic_harpoon_eel",
                name: "Harpoon Lava Eels",
                skill: SkillName.Fishing,
                requiredLevel: 53,
                loot: [
                    {
