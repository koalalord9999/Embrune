...
export const magusSpirePois: Record<string, POI> = {
    ...
    ms_f1_hall_south: {
        ...
        description: "A hallway lined with pulsing crystals.",
        connections: ["ms_f1_landing", "ms_f1_hall_west_1"],
        activities: [
            {
                type: "combat",
                monsterId: "mana_wisp",
    ...
    ms_f1_chamber_west: {
        id: "ms_f1_chamber_west",
        name: "Resonant Chamber (F1)",
        description: "A dead-end chamber where the humming of the crystals is noticeably louder.",
        connections: ["ms_f1_hall_west_1"],
        activities: [
            {
                type: "combat",
                monsterId: "arcane_familiar",
            },
        ],
        regionId: "magus_spire",
        x: 2000,
    ...
    ms_f1_hall_west_2: {
        id: "ms_f1_hall_west_2",
        name: "Winding Crystal Hall (F1)",
        description: "The path continues north.",
        connections: ["ms_f1_hall_west_1", "ms_f1_central_hall"],
        activities: [],
        regionId: "magus_spire",
        x: 2200,
        y: 900,
    ...
    ms_f1_central_hall: {
        id: "ms_f1_central_hall",
        name: "Central Hall (F1)",
        description: "A central point on this floor, connecting multiple passages.",
        connections: [
            "ms_f1_hall_west_2",
            "ms_f1_hall_east",
        ...
        activities: [
            {
                type: "combat",
                monsterId: "lesser_crystal_construct",
            },
        ],
        regionId: "magus_spire",
        x: 2200,
    ...
    ms_f1_hall_east: {
        id: "ms_f1_hall_east",
        name: "Winding Crystal Hall (F1)",
        description: "A long hallway stretching to the east.",
        connections: ["ms_f1_central_hall", "ms_f1_library"],
        activities: [
            {
                type: "combat",
                monsterId: "mana_wisp",
    ...
    ms_f1_library: {
        id: "ms_f1_library",
        name: "Arcane Library (F1)",
        description: "The remains of a once-great library. Scraps of ancient scrolls litter the floor.",
        connections: ["ms_f1_hall_east"],
        activities: [
            {
                type: "combat",
                monsterId: "enchanted_tome",
            },
            {
                type: "thieving_lockpick",
                id: "ms_chest_f1_library",
                targetName: "Arcane Lectern",
    ...
    ms_f1_nexus_north: {
        id: "ms_f1_nexus_north",
        name: "Northern Nexus (F1)",
        description: "The energies of the spire converge here, focused on a glowing staircase leading up.",
        connections: ["ms_f1_conjuring_room", "ms_f1_stairwell_up"],
        activities: [
            {
                type: "combat",
                monsterId: "spire_sentry",
    ...
    ms_f1_stairwell_up: {
        id: "ms_f1_stairwell_up",
        name: "Ascending Staircase (F1)",
        description: "A magical staircase spirals upwards into the spire's next level.",
        connections: ["ms_f1_nexus_north", "ms_f2_landing"],
        activities: [],
        regionId: "magus_spire",
        x: 2400,
        y: 700,
    ...
    ms_f2_landing: {
        id: "ms_f2_landing",
        name: "Second Floor Landing (F2)",
        description: "You arrive on the second floor. A staircase leads back down.",
        connections: ["ms_f1_stairwell_up", "ms_f2_hall_west_1"],
        activities: [],
        regionId: "magus_spire",
        x: 2400,
        y: 500,
    ...
    ms_f2_hall_west_1: {
        id: "ms_f2_hall_west_1",
        name: "Observation Hall (F2)",
        description: "Large, enchanted windows on the outer wall show a swirling view of the cosmos.",
        connections: ["ms_f2_landing", "ms_f2_hall_west_2"],
        activities: [
            {
                type: "combat",
                monsterId: "greater_mana_wisp",
            },
        ],
        regionId: "magus_spire",
        x: 2600,
    ...
    ms_f2_hall_west_2: {
        id: "ms_f2_hall_west_2",
        name: "Observation Hall (F2)",
        description: "The grand hall continues.",
        connections: [
            "ms_f2_hall_west_1",
            "ms_f2_golem_foundry",
    ...
    ms_f2_golem_foundry: {
        ...
        activities: [
            ...
            {
                type: "thieving_lockpick",
                id: "ms_chest_f2_foundry",
                targetName: "Construct Component Chest",
                lootTableId: "thieving_dungeon_chest_high",
            },
        ],
        regionId: "magus_spire",
    ...
    ms_f2_hall_south_1: {
        id: "ms_f2_hall_south_1",
        name: "Southern Passage (F2)",
        description: "A passage leading south.",
        connections: ["ms_f2_central_chamber", "ms_f2_hall_south_2"],
        activities: [
            {
                type: "combat",
                monsterId: "greater_mana_wisp",
    ...
    ms_f2_hall_south_2: {
        id: "ms_f2_hall_south_2",
        name: "Southern Passage (F2)",
        description: "The passage bends towards the west.",
        connections: ["ms_f2_hall_south_1", "ms_f2_stairwell_up"],
        activities: [
            {
                type: "combat",
                monsterId: "runic_guardian",
    ...
    ms_f2_stairwell_up: {
        id: "ms_f2_stairwell_up",
        name: "Ascending Staircase (F2)",
        description: "The glowing staircase continues its ascent to the next level.",
        connections: ["ms_f2_hall_south_2", "ms_f3_landing"],
        activities: [],
        regionId: "magus_spire",
        x: 2900,
        y: 450,
    ...
    ms_f3_hall_1: {
        ...
        description: "The air shimmers with conflicting elemental energies.",
        connections: ["ms_f3_landing", "ms_f3_hall_2"],
        activities: [
            {
                type: "combat",
                monsterId: "spire_spellweaver",
            },
        ],
        regionId: "magus_spire",
        x: 2850,
    ...
    ms_f3_hall_2: {
        ...
        activities: [
            {
                type: "combat",
                monsterId: "greater_crystal_construct",
            },
            {
                type: "agility_shortcut",
    ...
    ms_f3_stairwell_up: {
        id: "ms_f3_stairwell_up",
        name: "Ascending Staircase (F3)",
        description: "The glowing staircase leads higher into the spire.",
        connections: ["ms_f3_nexus_west", "ms_f4_landing"],
        activities: [
            {
                type: "combat",
                monsterId: "greater_crystal_construct",
    ...
    ms_f4_transmutation_lab: {
        ...
        activities: [
            {
                type: "combat",
                monsterId: "arcane_elemental",
            },
            {
                type: "thieving_lockpick",
                id: "ms_chest_f4_lab",
                targetName: "Alchemist's Satchel",
    ...
    ms_f4_hall_1: {
        id: "ms_f4_hall_1",
        name: "Summoner's Passage (F4)",
        description: "Intricate runes cover the walls of this passage.",
        connections: ["ms_f4_guardian_hall", "ms_f4_hall_2"],
        activities: [
            {
                type: "combat",
                monsterId: "spire_justicar",
    ...
    ms_f4_hall_2: {
        id: "ms_f4_hall_2",
        name: "Summoner's Passage (F4)",
        description: "The passage turns south.",
        connections: ["ms_f4_hall_1", "ms_f4_summoning_circle"],
        activities: [],
        regionId: "magus_spire",
        x: 2750,
        y: -900,
    ...
    ms_f4_stairwell_up: {
        id: "ms_f4_stairwell_up",
        name: "Apex Staircase (F4)",
        description: "The final staircase, guarded by a powerful creature, leading to the spire's apex.",
        connections: ["ms_f4_summoning_circle", "ms_f5_landing"],
        activities: [
            {
                type: "combat",
                monsterId: "crystal_hydra",
            },
        ],
        regionId: "magus_spire",
        x: 2350,
    ...
    ms_f5_landing: {
        id: "ms_f5_landing",
        name: "Spire Apex Landing (F5)",
        description: "You arrive at the top of the spire. A short path leads to an open-air platform. A staircase leads back down.",
        connections: ["ms_f4_stairwell_up", "ms_f5_crossroads"],
        activities: [],
        regionId: "magus_spire",
        x: 2500,
        y: -1200,
    ...
    ms_f5_crossroads: {
        id: "ms_f5_crossroads",
        name: "Apex Crossroads (F5)",
        description: "The path splits, leading to the west and east sides of the apex.",
        connections: [
            "ms_f5_landing",
            "ms_f5_wyvern_roost",
            "ms_f5_challenge_chamber",
        ],
        activities: [
            {
                type: "npc",
    ...
    ms_f5_challenge_chamber: {
        id: "ms_f5_challenge_chamber",
        name: "Challenge Chamber (F5)",
        description: "A dead-end chamber filled with the spire's most powerful guardians.",
        connections: ["ms_f5_crossroads"],
        activities: [
            {
                type: "combat",
                monsterId: "spire_justicar",
    ...
    ms_f5_wyvern_roost: {
        ...
        name: "Wyvern's Roost (F5)",
        description: "The apex of the spire, open to the swirling cosmos. A massive arcane wyvern guards a floating altar further on.",
        connections: ["ms_f5_crossroads", "ms_f5_astral_altar"],
        activities: [
            {
                type: "combat",
                monsterId: "arcane_wyvern",
            },
        ],
        regionId: "magus_spire",
        x: 2050,
