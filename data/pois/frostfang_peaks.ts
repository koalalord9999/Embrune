...
export const frostfangPeaksPois: Record<string, POI> = {
    ...
    fp_foothills: {
        ...
        activities: [
            {
                type: "combat",
                monsterId: "frostfang_wolf",
            },
            {
                type: "skilling",
                id: "fp_foothills_maple",
                name: "Chop Maple",
            ...
            {
                type: "skilling",
                id: "fp_foothills_iron",
                name: "Mine Large Iron Rock",
    ...
    fp_frozen_waterfall: {
        ...
        activities: [
            ...
            {
                type: "skilling",
                id: "fp_waterfall_mithril",
                name: "Mine Large Mithril Vein",
                skill: SkillName.Mining,
                requiredLevel: 60,
                loot: [
                    {
    ...
    fp_deep_mine: {
        ...
        activities: [
            ...
            {
                type: "skilling",
                id: "fp_deep_mine_adamantite",
                name: "Mine Large Adamantite Vein",
                skill: SkillName.Mining,
                requiredLevel: 70,
                loot: [
                    {
