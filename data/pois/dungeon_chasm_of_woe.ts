...
export const chasmOfWoePois: Record<string, POI> = {
    ...
    chasm_ledge_1: {
        ...
        activities: [
            {
                type: "ladder",
                name: "Climb back to Outpost",
                direction: "up",
                toPoiId: "chasm_of_woe_entrance",
            },
            {
                type: "combat",
                monsterId: "chasm_crawler",
            },
            {
                type: "skilling",
                id: "chasm_ledge_gold_1",
                name: "Mine Gold Rock",
    ...
    earth_render_lair: {
        ...
        activities: [
            ...
            },
            {
                type: "thieving_lockpick",
                id: "cwoe_chest_3",
                targetName: "Ancient Dwarven Chest",
