...
export const sunbrightPlainsPois: Record<string, POI> = {
    ...
    sunbright_cave_entrance: {
        ...
        activities: [
            {
                type: "ladder",
                name: "Descend into Cave",
                direction: "down",
                toPoiId: "suc_entrance",
            },
        ],
        regionId: "sunbright_plains",
        x: 1580,
    ...
    sp_rocky_outcrop: {
        ...
        activities: [
            ...
            {
                type: "skilling",
                id: "sp_rocky_silver_1",
                name: "Mine Large Silver",
                skill: SkillName.Mining,
                requiredLevel: 35,
                loot: [
                    {
    ...
    sp_abandoned_watchtower: {
        ...
        activities: [
            ...
            {
                type: "thieving_lockpick",
                id: "sp_watchtower_chest_1",
                targetName: "Bandit Chest",
                lootTableId: "thieving_dungeon_chest_low",
            },
        ],
        regionId: "sunbright_plains",
    ...
    sp_ancient_monolith: {
        ...
        activities: [
            ...
            {
                id: "monolith_pit_1_empty",
                type: "npc",
                name: "Empty Fire Pit",
                icon: "fire-pit",
                startNode: "tst_pit_1_empty",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_1",
                        value: false,
                        operator: "eq",
                    },
                ],
            ...
            {
                id: "monolith_pit_1_lit",
                type: "npc",
                name: "Lit Fire Pit",
                icon: "fire-lit",
                startNode: "tst_pit_1_lit",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_1",
            ...
            {
                id: "monolith_pit_1_mystical",
                type: "npc",
                name: "Mystical Fire Pit",
                icon: "fire-mystical",
                startNode: "tst_pit_1_mystical",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_1",
            ...
            {
                id: "monolith_pit_2_empty",
                type: "npc",
                name: "Empty Fire Pit",
                icon: "fire-pit",
                startNode: "tst_pit_2_empty",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_2",
                        value: false,
                        operator: "eq",
                    },
                ],
            ...
            {
                id: "monolith_pit_2_lit",
                type: "npc",
                name: "Lit Fire Pit",
                icon: "fire-lit",
                startNode: "tst_pit_2_lit",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_2",
            ...
            {
                id: "monolith_pit_2_mystical",
                type: "npc",
                name: "Mystical Fire Pit",
                icon: "fire-mystical",
                startNode: "tst_pit_2_mystical",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_2",
            ...
            {
                id: "monolith_pit_3_empty",
                type: "npc",
                name: "Empty Fire Pit",
                icon: "fire-pit",
                startNode: "tst_pit_3_empty",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_3",
                        value: false,
                        operator: "eq",
                    },
                ],
            ...
            {
                id: "monolith_pit_3_lit",
                type: "npc",
                name: "Lit Fire Pit",
                icon: "fire-lit",
                startNode: "tst_pit_3_lit",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_3",
            ...
            {
                id: "monolith_pit_3_mystical",
                type: "npc",
                name: "Mystical Fire Pit",
                icon: "fire-mystical",
                startNode: "tst_pit_3_mystical",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_3",
            ...
            {
                id: "monolith_pit_4_empty",
                type: "npc",
                name: "Empty Fire Pit",
                icon: "fire-pit",
                startNode: "tst_pit_4_empty",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_4",
                        value: false,
                        operator: "eq",
                    },
                ],
            ...
            {
                id: "monolith_pit_4_lit",
                type: "npc",
                name: "Lit Fire Pit",
                icon: "fire-lit",
                startNode: "tst_pit_4_lit",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_4",
            ...
            {
                id: "monolith_pit_4_mystical",
                type: "npc",
                name: "Mystical Fire Pit",
                icon: "fire-mystical",
                startNode: "tst_pit_4_mystical",
                visibilityCheck: [
                    {
                        type: "world_state",
                        property: "monolith_pit_4",
