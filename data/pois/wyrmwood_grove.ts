...
export const wyrmwoodGrovePois: Record<string, POI> = {
    ...
    wg_travelers_shrine: { id: 'wg_travelers_shrine', name: 'Traveler\'s Shrine', description: 'A small, weathered shrine to the god of journeys stands by the path.', connections: ['wg_southern_path_1', 'wg_southern_fork'], activities: [{ type: 'combat', monsterId: 'wispwood_spirit' }, { type: 'combat', monsterId: 'wispwood_spirit' }], regionId: 'wyrmwood_grove', x: 1760, y: 1510 },
    ...
    wg_hunters_path: { id: 'wg_hunters_path', name: 'Hunter\'s Path', description: 'A smaller path, marked by animal tracks.', connections: ['wg_southern_fork', 'wg_boar_clearing'], activities: [{ type: 'combat', monsterId: 'feywood_stalker' }, { type: 'combat', monsterId: 'feywood_stalker' }], regionId: 'wyrmwood_grove', x: 1800, y: 1545 },
    wg_boar_clearing: { id: 'wg_boar_clearing', name: 'Boar Clearing', description: 'A small clearing where the ground is torn up by wild boars.', connections: ['wg_hunters_path', 'wg_hunters_camp', 'wg_river_crossing'], activities: [{ type: 'combat', monsterId: 'enchanted_boar' }, { type: 'combat', monsterId: 'enchanted_boar' }], regionId: 'wyrmwood_grove', x: 1830, y: 1550 },
    ...
    wg_dragon_lair_approach: { id: 'wg_dragon_lair_approach', name: 'Dragon Lair Approach', description: 'The path is littered with scorched bones and massive scales.', connections: ['wg_tangled_thicket', 'wg_young_dragon_lair', 'wg_dragonling_nest'], activities: [{ type: 'combat', monsterId: 'feral_dragonling' }], regionId: 'wyrmwood_grove', x: 1825, y: 1445 },
    wg_young_dragon_lair: { id: 'wg_young_dragon_lair', name: 'Young Dragon Lair', description: 'A large clearing dominated by young, but still formidable, Grove Dragons.', connections: ['wg_dragon_lair_approach', 'wg_dragon_peak'], activities: [{ type: 'combat', monsterId: 'grove_dragon' }, { type: 'combat', monsterId: 'grove_dragon' }], regionId: 'wyrmwood_grove', x: 1855, y: 1440 },
    ...
    wg_ancient_yew_grove: { id: 'wg_ancient_yew_grove', name: 'Ancient Yew Grove', description: 'A secluded grove of ancient, gnarled Yew trees.', connections: ['wg_dragon_peak', 'wg_tangled_thicket'], activities: [{ type: 'combat', monsterId: 'corrupted_treant' }], regionId: 'wyrmwood_grove', x: 1845, y: 1400 },
    ...
    wg_waterfall_cave: { id: 'wg_waterfall_cave', name: 'Waterfall Cave', description: 'A small cave hidden behind a curtain of falling water.', connections: ['wg_whispering_stream_2', 'wg_elemental_shrine'], activities: [{ type: 'combat', monsterId: 'elder_grove_spirit' }], regionId: 'wyrmwood_grove', x: 1750, y: 1385 },
    wg_elemental_shrine: {
        id: 'wg_elemental_shrine', name: 'Elemental Shrine', description: 'A hidden shrine dedicated to the spirits of the forest.', connections: ['wg_waterfall_cave'], activities: [
            {
                type: 'npc',
                name: 'Elemental Shrine',
                icon: 'shrine',
                startNode: 'elemental_shrine_hub',
                questCondition: { questId: 'the_sorcerers_trial', stages: [17, 18, 19], visibleAfterCompletion: true },
        ...
        ], regionId: 'wyrmwood_grove', x: 1720, y: 1380
    },
    ...
    wg_secluded_clearing: {
        ...
        activities: [
            ...
            },
            {
                ...
                conditionalGreetings: [
                    { text: "Go away. The trees and I are having a very important conversation about the philosophical implications of photosynthesis.", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', stage: 1 }] } },
                    { text: "The stone is speaking to the light in the wide, open plains... or so the maples say. They're such gossips.", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', stage: 2 }] } },
                    { text: "A knot in the weave... a gathering of will. The ancient yews are restless tonight. They sense a spark that doesn't belong to the sun.", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', operator: 'gte', stage: 3 }, { type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', operator: 'lt', stage: 6 }] } },
                    { text: "Sharp, angry tremors from the south... like a child with a hammer. The roots are complaining about the vibrations. Why must everyone be so... loud?", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', operator: 'gte', stage: 6 }, { type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', operator: 'lt', stage: 13 }] } },
                    { text: "The air smells of metal and ice... a strange, alchemical winter. The world is being rewritten, Seeker... and I'm not sure I like the new prose.", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', operator: 'gte', stage: 13 }, { type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', operator: 'lt', stage: 17 }] } },
                    { text: "The wind is carrying a song from the old shrine... a song of three parts becoming one. The moss says it's time. Time for what? Moss is never very clear.", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', operator: 'gte', stage: 17 }, { type: 'quest', questId: 'the_sorcerers_trial', status: 'in_progress', operator: 'lt', stage: 20 }] } },
                    { text: "The storm has passed, but the air still tastes of gold. The trees are quiet now... respectful. You've changed the world's grammar, haven't you? Now... leave me to my ferns.", check: { requirements: [{ type: 'quest', questId: 'the_sorcerers_trial', status: 'completed' }] } },
                ]
            },
        ],
        regionId: 'wyrmwood_grove',
